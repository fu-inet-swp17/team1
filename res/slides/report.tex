...
\section{Einführung}
  ...
  "ahnliche Spieleautomaten umzuwandeln.\\ % TODO Singular (TEILE) und Plural
  %(PDP11) in einem Satz
...
\section{Hardware}
  ...
  \subsection{Treiber}
    ...
    %TODO angelehnt an Beispieltreiber
...
\section{Stand der Umsetzung}
  ...
  % TODO: konsistente API zu netzwerkcode, keine trennung von businnes zu
  % netzwerk
